...
schedule.every().day.at(HOUR_DAY_2_ACTION).do(fetchAllInformationActions, "jumpStart") # ACAO
schedule.every().day.at(HOUR_DAY_3_ACTION).do(fetchAllInformationActions, "jumpStart") # ACAO
